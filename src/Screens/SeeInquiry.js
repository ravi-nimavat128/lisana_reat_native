...
class SeeInquiry extends Component {
  constructor(props) {
    super(props);
    this.state = {
      inq_id: 0,
      ...
      <SafeAreaView style={{backgroundColor: 'white', flex: 1}}>
        ...
        <ScrollView>
          ...
          {this.props.route.params.type == 1 ? (
            <TouchableOpacity
              onPress={() =>
                this.props.navigation.navigate('EditInquiry', {
          ...
          <TouchableOpacity onPress={() => this.selectMultipleFile()} disabled>
            <ImageBackground
              style={{
                height: 40,
                marginTop: 15,
...
export default connect(mapStateToProps, mapDispatchToProps)(SeeInquiry);
